...
public:
    ...
    void AddKey(const char *, int);
    void SetMiner(int t) {
        m_currentMiningKey = t;
        UpdateKeyUI(t);
    }
    int MiningKey() {
        return m_currentMiningKey;
    }
    void OmegaSart();
    void OmegaClose();
    std::wstring GetPassword(bool quick);
    bool Ready();
    bool ready() { return serverReady; }
...
private:
    ...
    void UpdateKeyUI(int);
    void ToggleAADSSO();
    void updateLockTimeUI(int id);
